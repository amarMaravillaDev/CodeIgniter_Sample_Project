...
<main class="bg-light border-end border-primary w-100 h-100 d-flex flex-column align-items-center overflow-auto">
    <!-- Top Navigations -->
    ...
    <!-- Main Content -->
    <div class="w-100 h-100 overflow-auto position-relative p-4">
